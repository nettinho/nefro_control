defmodule NefroControlWeb.EventLiveTest do
  use NefroControlWeb.ConnCase

  import Phoenix.LiveViewTest
  import NefroControl.ControlFixtures

  @create_attrs %{timestamp: "2024-06-11T20:22:00Z", comments: "some comments"}
  @update_attrs %{timestamp: "2024-06-12T20:22:00Z", comments: "some updated comments"}
