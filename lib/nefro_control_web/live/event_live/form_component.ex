defmodule NefroControlWeb.EventLive.FormComponent do
  ...
  def update(%{event: event} = assigns, socket) do
    changeset = Control.change_event(event)
  ...
  def handle_event("validate", %{"event" => event_params}, socket) do
    changeset =
      ...
      |> Control.change_event(event_params)
  ...
  defp save_event(socket, :edit, event_params) do
    case Control.update_event(socket.assigns.event, event_params) do
      {:ok, event} ->
  ...
  defp save_event(socket, :new, event_params) do
    case Control.create_event(event_params) do
      {:ok, event} ->
        notify_parent({:saved, event})
